...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		$options['google_mixed_3'] = array( 'name' => 'Body Text',
							...
							'id' => 'google_mixed_3',
							'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#777777'),
							'type' => 'typography',
							'options' => array(
		...
		$options['h1_heading'] = array( 'name' => 'H1 Heading',
							...
							'id' => 'h1_heading',
							'std' => array( 'size' => '36px', 'lineheight' => '42px', 'face' => '"Times New Roman", Times, serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h2_heading'] = array( 'name' => 'H2 Heading',
							...
							'id' => 'h2_heading',
							'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => '"Times New Roman", Times, serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h3_heading'] = array( 'name' => 'H3 Heading',
							...
							'id' => 'h3_heading',
							'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => '"Times New Roman", Times, serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h4_heading'] = array( 'name' => 'H4 Heading',
							...
							'id' => 'h4_heading',
							'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => '"Times New Roman", Times, serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['h5_heading'] = array( 'name' => 'H5 Heading',
							...
							'id' => 'h5_heading',
							'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => '"Times New Roman", Times, serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options['slogan'] = array( "name" => "Slogan",
							"desc" => "Slogan on homepage",
							"id" => "slogan",
							"std" => "In need of some quick advice? Need to know the next step you should take?<strong><a href='contacts'>Use Ask a Lawyer!</a></strong>",
							"type" => "textarea" );
		...
		$options[] = array( 'name' => 'Logo Typography',
							...
							'id' => 'logo_typography',
							'std' => array( 'size' => '70px', 'lineheight' => '70px', 'face' => 'Playball', 'style' => 'normal', 'character'  => 'latin', 'color' => '#000000'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
		...
		$options[] = array( 'name' => 'Footer Menu Typography',
							...
							'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#929191'),
							'type' => 'typography',
							'options' => array(
									'faces' => $typography_mixed_fonts )
							);
