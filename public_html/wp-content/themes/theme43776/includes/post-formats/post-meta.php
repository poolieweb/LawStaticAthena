...
<?php if ($post_meta=='true' || $post_meta=='') { ?>
	...
	<div class="post_meta">
		...
		<span class="post_permalink"><i class="icon-link"></i><a href="<?php the_permalink(); ?>" title="<?php _e('Permalink to:', CURRENT_THEME);?> <?php the_title(); ?>"><?php _e('Permalink', CURRENT_THEME) ?></a></span>
	</div>
	<!--// Post Meta -->
<?php } ?>